...
class User:
    ...
    def from_dict(obj: dict):
        ...
        if obj.get('account_number') == None:
            return None, 'No account_number send in the request'
        if obj.get('password') == None:
            return None, 'No password send in the request'
        if obj.get('role') == None or obj.get('role_key') == None:
            return None, 'No role send in the request'
        if obj.get('account_number') == None:
            return None, 'No email, nick_name'
        # Auth
        ...
        if not account_number.isdigit() and len(account_number) != 9:
            return None, 'account_number invalid'
        ...
        return User(nick_name,password,email,name ,last_name_fathers ,last_name_mothers,account_number,careers,role ,role_key,half_year), 'Succesful User'
